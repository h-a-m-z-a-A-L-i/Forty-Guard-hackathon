...
export const departureWindow = (origin, destination, atTime, signal) => axios.post(`${API}/api/departure-window`, { origin, destination, atTime }, { signal, timeout: 120000 }).then(r => r.data);
